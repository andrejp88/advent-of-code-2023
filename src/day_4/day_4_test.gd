...
func test_get_point_value_of_line() -> void:
	assert_eq(day_4.get_point_value_of_line("Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53"), 8)
	assert_eq(day_4.get_point_value_of_line("Card 2: 13 32 20 16 61 | 61 30 68 82 17 32 24 19"), 2)
	assert_eq(day_4.get_point_value_of_line("Card 3:  1 21 53 59 44 | 69 82 63 72 16 21 14  1"), 2)
	assert_eq(day_4.get_point_value_of_line("Card 4: 41 92 73 84 69 | 59 84 76 51 58  5 54 83"), 1)
	assert_eq(day_4.get_point_value_of_line("Card 5: 87 83 26 28 32 | 88 30 70 12 93 22 82 36"), 0)
	assert_eq(day_4.get_point_value_of_line("Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11"), 0)
