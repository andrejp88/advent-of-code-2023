...
func part_1(input: String) -> int:
	...
	lines.sort_custom(
		func(a: String, b: String) -> bool:
			...
			var a_hand_type := get_hand_type(a_hand)
			var b_hand_type := get_hand_type(b_hand)
			...
			for i in 5:
				...
				if a_card != b_card:
					return rank_to_index[a_card] < rank_to_index[b_card]
...
func get_hand_type(hand: String) -> HandType:
